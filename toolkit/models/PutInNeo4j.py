...
#导入实体
print('实体加载开始：')
neo4jmodel.createNode('../../data/csvOrTxtFiles/jkw_39_another_names.csv','Disease') # 导入疾病别名
neo4jmodel.createNode('../../data/csvOrTxtFiles/jkw_39_complications.csv','Symptom') # 导入并发症实体
neo4jmodel.createNode('../../data/csvOrTxtFiles/jkw_39_examines.csv','Operation') #导入检查实体
neo4jmodel.createNode('../../data/csvOrTxtFiles/jkw_39_illness.csv','Disease') #导入疾病实体
neo4jmodel.createNode('../../data/csvOrTxtFiles/jkw_39_positions.csv','Pathogenic_Site')  #导入病发部位
neo4jmodel.createNode('../../data/csvOrTxtFiles/jkw_39_drugs.csv','Drug') #导入药品实体
neo4jmodel.createNode('../../data/csvOrTxtFiles/jkw_39_surgeries.csv','Check') #导入手术实体
neo4jmodel.createNode('../../data/csvOrTxtFiles/jkw_39_symptom.csv','Symptom') #导入症状实体
neo4jmodel.createNode('../../data/csvOrTxtFiles/jkw_39_deparments.csv','Department') #导入科室
print('实体加载完毕！！')
#导入关系
# 导入病名实体和病名别名实体之间的关系
print('加载关系！！')
